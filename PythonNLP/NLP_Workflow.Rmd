...
### - Need to set the number of Topics
### - Can first run a Grid search for optimum separation
```{python, echo=FALSE, warning=FALSE, message=FALSE}
...
### - Groupings use bigrams
### - Color scale represents topics
```{python}
...
# iplot(fig)
topicplot = pyo.plot(fig, filename='topic.html', auto_open=False)
```


```{r, echo=FALSE, warning=FALSE, message=FALSE}
htmltools::includeHTML("topic.html")
